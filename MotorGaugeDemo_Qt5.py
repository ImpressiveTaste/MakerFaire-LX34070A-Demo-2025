#!/usr/bin/env python3
"""Motor position gauge demo using PyQt5.
...
class MotorGaugeDemo(QtWidgets.QMainWindow):
    ...
    def _build_ui(self) -> None:
        ...
        vbox.addWidget(self.stack, alignment=QtCore.Qt.AlignHCenter)
        ...
        self.lbl_angle.setAlignment(QtCore.Qt.AlignHCenter)
        vbox.addWidget(self.lbl_angle)

        self.lbl_speed = QtWidgets.QLabel("Speed: —")
        self.lbl_speed.setAlignment(QtCore.Qt.AlignHCenter)
        vbox.addWidget(self.lbl_speed)

        self.lbl_turns = QtWidgets.QLabel("Turns: —")
        self.lbl_turns.setAlignment(QtCore.Qt.AlignHCenter)
        vbox.addWidget(self.lbl_turns)

        self.lbl_quality = QtWidgets.QLabel("Quality: —")
        self.lbl_quality.setAlignment(QtCore.Qt.AlignHCenter)
